...
- On iPhone/iPad, the terminal refits to the visible area when the software keyboard opens or closes, keeping both terminal output and the composer above the keyboard. If you were following live output at the bottom, keyboard resizing keeps that bottom position; an intentionally opened history position stays in history.
