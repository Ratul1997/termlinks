...
- On iPhone/iPad, the terminal refits to the visible area when the software keyboard opens or closes, keeping both terminal output and the composer above the keyboard.
