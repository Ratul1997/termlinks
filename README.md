...
- Use the bottom terminal bar like tmux or browser tabs: tap a named live-session tab to switch terminals, tap **☷** for the full session dashboard, or tap **+** to open the New terminal form. Switching tabs reconnects to the selected daemon-owned PTY; it does not restart the command.
