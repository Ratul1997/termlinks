...
- Compose mode's **+** button accepts any file supported by the encrypted transfer, saves it on the connected computer, and inserts its shell-quoted local path exactly at the command cursor.
