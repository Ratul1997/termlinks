/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=.dev.vars.example --strict-vars=false` (hash: 5f233402536fa6c3dc407bad03cf7215)
// Runtime types generated with workerd@1.20260831.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
	CONNECTOR_TOKEN: string;
	RELAY: DurableObjectNamespace<import("./src/index").TermlinksRelay>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TermlinksRelay";
	}
